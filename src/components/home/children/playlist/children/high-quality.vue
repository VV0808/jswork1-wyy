        ...
        <div class="tags">
          ...
          <div class="hide-on-large-only">
            ...
            <span
              ...
              @click="selectItem(item)"
              v-for="(item,index) in tags"
              style="line-height:8px;margin:2px"
            >
              <div
                class="chip"
                style="font-size:10px;height:20px;text-align:center;line-height:20px"
              >
                {{item}}
                <span v-if="item==cat">
                  (
                ...
                <i class="close material-icons" style="line-height:20px;font-size:10px">x</i>
              </div>
            </span>
          </div>
        </div>
        ...
        <div class="hide-on-large-only">
          <ul class="list" v-if="playList.length>0">
            ...
            >
              ...
              <div class="name" style="font-size:11px;line-height:14px">{{item.name}}</div>
            </router-link>
          </ul>
          <div class="no-data" v-else>没有获取到数据</div>
          <div class="loadMore-text" @click="loadMore" v-show="hasMore" style="font-size:13px">加载更多</div>
        </div>
      </div>
    </section>
  </transition>
