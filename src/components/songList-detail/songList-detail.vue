  ...
  <section class="detail" v-if="songListDetail">
    <div class="container">
      <div class="hide-on-med-and-down">
        <div class="header">
          ...
          <div class="info">
            ...
            <div class="btn-play" @click="random">
              <span class="icon-music"></span> 随机播放全部
            </div>
          </div>
        </div>
      </div>
      <div class="hide-on-large-only">
        <div class="header">
          <img :src="songListDetail.coverImgUrl" class="avatar" style="width:40%;height:50%">
          <div class="info">
            <div class="name" style="font-size:12px">
              <span class="label" style="font-size:12px">歌单</span>
              {{songListDetail.name}}
            </div>
            ...
            <!-- <div class="desc" style="font-size:12px">简介：{{songListDetail.description}}</div> -->
            <div class="btn-play" @click="random" style="font-size:12px;margin-top:5%">
              <span class="icon-music"></span> 随机播放全部
            </div>
          </div>
        </div>
        ...
        <div class="hide-on-large-only">
          <div class="tab-header">
            <ul class="left" style="width:100%">
              <li class="item current" style="width:40%">歌曲列表</li>
              <li class="item" style="width:20%">评论</li>
              <li class="item" style="width:20%">收藏者</li>
            </ul>
            <div class="right"></div>
          </div>
        </div>
